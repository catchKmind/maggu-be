...
class PlaceFolderServiceTest {
    ...
    class CreatePlaceFolder {
        ...
        void createsFolderAndReturnsSavedInfo() {
            ...
            PlaceFolderCreateResponse result = placeFolderService.createPlaceFolder(user, request);
        ...
        void alwaysSavesAsNonDefaultFolder() {
            ...
            placeFolderService.createPlaceFolder(user, request);
        ...
        void throwsWhenNameAlreadyExistsForUser() {
            ...
            assertThatThrownBy(() -> placeFolderService.createPlaceFolder(user, request))
    ...
    class CreateDefaultPlaceFolder {
        ...
        void createsDefaultFolderWithFixedNameAndIcon() {
            ...
            placeFolderService.createDefaultPlaceFolder(user);
